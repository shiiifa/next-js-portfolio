...
Sign up for a [Mailchimp account](https://mailchimp.com) and create a new list if you do not have one.
...
There is a pre-configured background in `Mailchimp.tsx` that you can modify in the `mailchimp` object. Set graphic elements such as gradient, dots, lines, and grid and configure their appearance for the newsletter block.

...
The frontmatter is used to set the project's metadata: title, description, image, and tags. It is used in the project's page and in meta- and open graph tags.
...
Hot reload of MDX files is currently not supported, but we are working on it.
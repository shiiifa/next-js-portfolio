...
export async function generateMetadata() {
  return Meta.generate({
    ...
    path: "/projects/4dof-robotic-arm",
    baseURL,
  });
}
  ...
  return (
    <Column maxWidth="m" paddingTop="24">
      ...
      <Column paddingX="l" gap="xl">
        ...
        <Card padding="l" radius="m" shadow="m">
          <Column gap="m">
            <Heading variant="heading-strong-l">Project Management</Heading>
            <Text variant="body-default-m">
              <strong>Structured Planning:</strong> Used Gantt charts for project timeline management and task coordination.
            </Text>
            <Text variant="body-default-m">
              <strong>Team Collaboration:</strong> Notion-based project management for team coordination and documentation.
            </Text>
            <Text variant="body-default-m">
              <strong>Design Process:</strong> Applied complete engineering design cycle from ideation to final implementation.
            </Text>
            <Text variant="body-default-m">
              <strong>Documentation:</strong> Comprehensive project documentation and technical specifications.
            </Text>
          </Column>
        </Card>
